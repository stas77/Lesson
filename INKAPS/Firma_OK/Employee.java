...
public class Employee {
    ...
    public String KK(){
        String GG;
        GG=" Имя: " + this.name + " Зар/пл=ставка*(Kвозр+Kостаж+Kстжк+Kдолж) "+
                this.stavka+"*("+this.Kage()+"+"+this.Kwe()+"+"+this.Kwec()+"+"+this.Kp()+")="+this.Salery;
       // System.out.println();
        return GG;
    }
    ...
    public String ID(){ //печать
      ...
      //                    " Общий стаж: "+this.WrExp+" стаж в компании: "+this.WrExprComp+" Зар/плата: "+this.Salery);
        GG="Должность: "+this.position+" Имя: "+this.name+" возраст "+this.age+
                            " Общий стаж: "+this.WrExp+" стаж в компании: "+this.WrExprComp+" Зар/плата: "+this.Salery;
        return GG;
    }
}
